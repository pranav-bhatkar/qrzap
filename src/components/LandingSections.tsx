...
function MCPSection() {
  const tabs = [
    { id: "claude-code", label: "Claude Code", cmd: "claude mcp add qrzap -- npx qrzap-mcp@latest" },
    ...
    <Section id="opensource" className="border-t border-border/10">
      <div className="text-center max-w-lg mx-auto">
        ...
        <div className="flex items-center justify-center gap-3">
          ...
          <a href="https://www.npmjs.com/package/qrzap-mcp" target="_blank" rel="noopener noreferrer">
            <Button variant="outline" className="gap-2 text-xs">
